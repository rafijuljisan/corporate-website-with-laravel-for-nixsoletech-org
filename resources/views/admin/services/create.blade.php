                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Add New Service</h6>
                                    <p class="text-sm mb-0">Create a new service offering for the public website.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('services.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" rows="5" class="form-control" required placeholder="Describe what this service entails..."></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="icon" id="icon" class="form-control" placeholder="e.g., fas fa-laptop or a Bootstrap icon class">
